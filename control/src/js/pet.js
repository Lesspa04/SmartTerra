...
const PET_STAGES = [
  {
    ...
    speech: [
      ...
      'Solo soy potencial. Tú decides si me das vida.',
      'El planeta me está esperando. ¿Y tú?',
      '...',
    ],
  },
  {
  ...
  },
  {
    ...
    speech: [
      ...
      'Me están saliendo hojitas. Es por ti.',
      'Ya puedo ver el sol. ¡Gracias por cuidarme!',
      'Antes era una semilla asustada. Mira ahora.',
      'La racha que llevas me tiene emocionado.',
      'Todavía no soy el Guardián, pero vamos bien.',
      'Si sigues así, pronto seré imparable.',
      'Me estoy poniendo grande y tú eres la razón.',
    ],
  },
  {
    id:      'full',
    ...
    speech: [
      ...
      'Llegué hasta aquí gracias a ti. No lo olvido.',
      'Ahora cuido el planeta contigo. Somos un equipo.',
      'Poderoso y verde. Exactamente como me gusta.',
      'Los accesorios me quedan bien, ¿verdad?',
      'Dicen que soy el Guardián. Yo digo que somos dos.',
      'No hay etapa 4, pero si hubiera, ya estaríamos ahí.',
      'Sigo aquí. Siempre voy a seguir aquí.',
      'La Tierra me pidió que te diera las gracias.',
      '¿Sombrero Vueltiao o Ruana? Decisiones difíciles.',
    ],
  },
]
